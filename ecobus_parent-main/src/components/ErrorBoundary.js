  ...
  render() {
    ...
    return (
      <View style={s.root}>
        {/* Background glow */}
        <Animated.View
          style={[s.glow, { transform: [{ scale: this.pulse }] }]}
          pointerEvents="none"
        />
...
const s = StyleSheet.create({
  ...
  /* Badge rings */
  badgeOuter: {
    width: BADGE + 52, height: BADGE + 52, borderRadius: (BADGE + 52) / 2,
  ...
  badgeMid: {
    width: BADGE + 26, height: BADGE + 26, borderRadius: (BADGE + 26) / 2,
