...
/**
 * Inline 3-pill language switcher.
 * `variant="light"` — for use on white/light backgrounds (Login card).
 * `variant="dark"`  — for use on dark navy backgrounds (Onboarding, Splash).
 */
        ...
        return (
          <Pressable
            ...
            style={[
              ...
              active
                ? s.pillActive
                : isDark ? s.pillIdleDark : s.pillIdleLight,
            ]}
          ...
          >
            <Text
              style={[
                ...
                active
                  ? s.pillTextActive
                  : isDark ? s.pillTextDark : s.pillTextLight,
              ]}
