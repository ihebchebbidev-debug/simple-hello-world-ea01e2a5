...
export const LOCALE_STORAGE_KEY = '@ecobus/locale';
...
export async function setupI18n() {
  ...
  // Sync RTL on startup (no reload — only the user-triggered change does that)
...
export async function changeLanguage(lng) {
  ...
  // i18n.changeLanguage fires the 'languageChanged' event, which DirectionProvider
  // in App.js listens to and flips the root direction: 'rtl'/'ltr' instantly.
